  ...
  return (
    ...
    >
      <Link
        ...
        aria-label="Accueil"
        className={cn(
          "grid h-11 w-11 place-items-center rounded-full border border-white/10",
          "bg-[rgba(11,15,20,0.55)] backdrop-blur shadow-lg",
          "text-white/85 hover:text-white",
          "select-none touch-manipulation transition duration-150 will-change-transform",
          "active:scale-[0.96] active:opacity-90",
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--cp-accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--cp-bg)]",
        )}
      >
