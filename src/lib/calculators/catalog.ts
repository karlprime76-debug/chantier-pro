...
export const CALCULATORS_CATALOG: CalculatorCatalogItem[] = [
  ...
  {
    id: "lab_sieve_analysis",
    title: "Analyse granulométrique (tamis)",
    description: "% retenu, passant cumulé et tableau de synthèse.",
    category: "Laboratoire / Contrôle qualité",
    plan: "PREMIUM",
    href: "/dashboard/calculators/lab/sieve-analysis",
    featureKey: "lab_sieve_analysis",
    status: "AVAILABLE",
    iconName: "🧺",
    isAvailable: true,
  },
  {
    id: "lab_sand_fineness_modulus",
    title: "Module de finesse du sable",
    description: "Calcul MF + interprétation indicative.",
    category: "Laboratoire / Contrôle qualité",
    plan: "PREMIUM",
    href: "/dashboard/calculators/lab/sand-fineness-modulus",
    featureKey: "lab_sand_fineness_modulus",
    status: "AVAILABLE",
    iconName: "🏖️",
    isAvailable: true,
  },
  {
    id: "lab_aggregate_moisture",
    title: "Teneur en eau (granulats)",
    description: "Humidité (%) à partir de masses humide/sèche.",
    category: "Laboratoire / Contrôle qualité",
    plan: "PREMIUM",
    href: "/dashboard/calculators/lab/aggregate-moisture",
    featureKey: "lab_aggregate_moisture",
    status: "AVAILABLE",
    iconName: "💧",
    isAvailable: true,
  },
  {
    ...
    description: "kg/m³ à partir de masse et volume (granulats/sol).",
    category: "Laboratoire / Contrôle qualité",
    plan: "PREMIUM",
    href: "/dashboard/calculators/lab/bulk-density",
    featureKey: "lab_bulk_density",
    status: "AVAILABLE",
    iconName: "⚖️",
    isAvailable: true,
  },
  {
    id: "lab_soil_moisture",
    title: "Teneur en eau du sol",
    description: "Humidité (%) à partir de masses humide/sèche.",
    category: "Laboratoire / Contrôle qualité",
    plan: "PREMIUM",
    href: "/dashboard/calculators/lab/soil-moisture",
    featureKey: "lab_soil_moisture",
    status: "AVAILABLE",
    iconName: "🧱",
    isAvailable: true,
  },
  {
    ...
    description: "Calcul densité sèche à partir de densité humide et w%.",
    category: "Laboratoire / Contrôle qualité",
    plan: "PREMIUM",
    href: "/dashboard/calculators/lab/dry-density",
    featureKey: "lab_dry_density",
    status: "AVAILABLE",
    iconName: "📦",
    isAvailable: true,
  },
  {
    id: "lab_compaction_degree",
    title: "Degré de compactage",
    description: "% compactage (densité sèche / densité max) + seuil.",
    category: "Laboratoire / Contrôle qualité",
    plan: "PREMIUM",
    href: "/dashboard/calculators/lab/compaction-degree",
    featureKey: "lab_compaction_degree",
    status: "AVAILABLE",
    iconName: "🚜",
    isAvailable: true,
  },
  {
    id: "lab_atterberg_limits",
    title: "Limites d’Atterberg (IP)",
    description: "IP = LL - PL + classification indicative.",
    category: "Laboratoire / Contrôle qualité",
    plan: "PREMIUM",
    href: "/dashboard/calculators/lab/atterberg-limits",
    featureKey: "lab_atterberg_limits",
    status: "AVAILABLE",
    iconName: "🧾",
    isAvailable: true,
  },
  {
    id: "lab_cbr_simplified",
    title: "CBR simplifié",
    description: "CBR 2,5 / 5 et CBR retenu (aide).",
    category: "Laboratoire / Contrôle qualité",
    plan: "PREMIUM",
    href: "/dashboard/calculators/lab/cbr-simplified",
    featureKey: "lab_cbr_simplified",
    status: "AVAILABLE",
    iconName: "📏",
    isAvailable: true,
  },
